  ...
  return (
    <Paper elevation = { 3 } sx = {{ padding: 3 }}>
      ...
      <Stack sx = {{ marginTop: 4 }} spacing = { 2 } >
        ...
        <TextField error = { userHeightError } required id = "userHeight" label = "Altura (cm)" variant = "standard" fullWidth  
        onChange = { (e) => setHeight(e.target.value) } type='number' value = { height } helperText = { userHeightMessage } />
        
        <TextField error = {userWeightError} required id = "userWeight" label = "Peso (kg)" variant = "standard" fullWidth 
        onChange = { (e) => setWeight(e.target.value) } type = 'number' value = { weight } helperText = { userWeightMessage } />
...

      {
          ...
          <Grid container spacing = { 3 } sx = {{ textAlign: 'center', paddingY: 2, marginY: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Grid item xs = { 12 } sm = { 6 }>
              ...
              <Paper elevation = { 3 } sx = {{ padding: 3 }} >
                ...
                <img src = { imageSrc } alt = "imcImage" height = { 128 } width = { 128 } style = {{ margin: '1em' }}/>
            ...
            <Grid item xs={ 12 } sm={ 6 } >
              ...
              <Paper elevation = { 3 } sx = {{ padding: 3 }} >
                ...
                <h2 style = {{ color: 'rgb(33,138,174)', marginTop: '.2em' }}> {(waterConsumption/1000).toFixed(2)} </h2>
                <h6 style = {{ color: 'rgb(33,138,174)', marginTop: '.5em' }}>litros de água por dia</h6>
                
                <Grid container spacing={ 2 } sx={{ marginTop: '.8em'}}>

                  <Grid item xs={ 12 } sm={ 6 }>
                    <img src = { bottle } alt="bottle" height = { 64 } width = { 64 } />  
                    <h6 style = {{ color: 'rgb(33,138,174)', marginTop: '.5em' }} >{ Math.round((waterConsumption/500)).toFixed(0) } garrafinhas de 500ml</h6>
                  </Grid>
                  
                  <Grid item xs={ 12 } sm={ 6 }>
                    <img src = {glass} alt = "glass" height = { 64 } width = { 64 } />  
                    <h6 style = {{ color: 'rgb(33,138,174)', marginTop: '.5em' }} >{ Math.round((waterConsumption/310)).toFixed(0) } copos de 310ml</h6>
                  </Grid>
      ...
      <Box sx={{ marginTop: 3, textAlign: 'right' }}>
        
        {
          ...
          <Button variant = "outlined" startIcon = { <RefreshIcon /> } sx = {{ color: 'rgb(33, 138, 174)', marginRight: 1 }} 
          onClick = { refresh } >
            Limpar
          </Button>
        }

        <Button variant = "outlined" startIcon = { <CalculateIcon /> } sx = {{ color: 'rgb(33, 138, 174)' }} 
        onClick = { calcBmi } >
          Calcular
        </Button>
